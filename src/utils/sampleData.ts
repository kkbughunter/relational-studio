  ...
  const relations: Relation[] = [
    {
      ...
      toTableId: 'categories-table',
      fromColumnId: 'products-category',
      toColumnId: 'categories-id',
      type: '1:N',
      onDelete: 'SET NULL',
      onUpdate: 'CASCADE',
    ...
    {
      id: 'rel-categories-parent',
      fromTableId: 'categories-table',
      toTableId: 'categories-table',
      fromColumnId: 'categories-parent',
      toColumnId: 'categories-id',
      type: '1:N',
      onDelete: 'SET NULL',
      onUpdate: 'CASCADE',
    ...
    },
    {
      ...
      toTableId: 'users-table',
      fromColumnId: 'orders-user',
      toColumnId: 'users-id',
      type: '1:N',
      onDelete: 'CASCADE',
      onUpdate: 'CASCADE',
    ...
    },
    {
      ...
      fromTableId: 'order-items-table',
      toTableId: 'orders-table',
      fromColumnId: 'order-items-order',
      toColumnId: 'orders-id',
      type: '1:N',
      onDelete: 'CASCADE',
      onUpdate: 'CASCADE',
    ...
    },
    {
      ...
      fromColumnId: 'order-items-product',
      toColumnId: 'products-id',
      type: '1:N',
      onDelete: 'RESTRICT',
      onUpdate: 'CASCADE',
